   ...
   public static class TestData
    {
       ...
       // public static Staff hostess2 = new Staff { PassportNumber = "3", FirstName = "hostess2", LastName = "hostess2", EmailAddress = "hostess2.hostess2@gmail.com", BirthDate = new DateTime(1996, 01, 01), EmployementDate =   new DateTime(2020, 01, 01), Salary = 999 };
        ...
        public static Flight flight2 = new Flight { airLine="TunisAir",FlightDate = new DateTime(2022, 02, 01,21,10,10), Destination = "Serbia",Departure="Tunisie", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration =105 , Plane = BoingPlane };
